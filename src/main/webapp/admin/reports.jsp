                    ...
                    <% for (Report report : reports) { %>
                        <div class="card mb-3">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-start mb-3">
                                    <div>
                                        <h5 class="card-title mb-1">
                                            ...
                                            <span class="badge bg-info"><%= report.getReportType() %></span>
                                        </h5>
                                        <p class="text-muted mb-0">
                                            <small>
                                                <i class="fas fa-user me-1"></i>Reported by: <%= report.getReporterUsername() %>
                                                <i class="fas fa-calendar ms-3 me-1"></i><%= report.getReportedAt() %>
                                            </small>
                                        </p>
                                    </div>
                                    <div>
                                ...
                                <div class="mb-3">
                                    <strong>Content ID:</strong> <%= report.getContentId() %>
                                    <span class="ms-3"><strong>Content Type:</strong> <%= report.getContentType() %></span>
                                </div>
                                
                                <div class="mb-3">
                                    <strong>Reason:</strong>
                                    <p class="mb-0"><%= report.getReason() %></p>
                                </div>
                                ...
                                <% if (report.getAdminId() != null) { %>
                                    <div class="alert alert-light mb-2">
                                        ...
                                        <small class="text-muted">Reviewed at: <%= report.getReviewedAt() %></small>
                                    </div>
                                <% } %>
